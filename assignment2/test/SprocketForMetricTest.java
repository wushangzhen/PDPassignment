...
/**
 * A test for metric sprocket.
 */
public class SprocketForMetricTest {

  private final int DOLLARS_FOR_SPROCKETS = 31;
  private final int CENTS_FOR_SPROCKETS = 92;
  private Price priceSprocket = new Price(DOLLARS_FOR_SPROCKETS, CENTS_FOR_SPROCKETS);
  private final String SKU_NUMBER_SPROCKETS = "6789K52";
  private final int NUMBER_OF_TEETH = 8;
  private final String DIAMETER_FOR_SHAFT = "1/8\"";
  SprocketForMetric sprocket = new SprocketForMetric(SKU_NUMBER_SPROCKETS, priceSprocket,
  ...
  public void getMeasurement() {
    assertEquals(sprocket.getMeasurement(), Measurement.METRIC);
  }
